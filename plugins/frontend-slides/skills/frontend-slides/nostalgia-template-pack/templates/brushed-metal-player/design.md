...
slug: brushed-metal-player
taxonomy: Y2K / Aqua / Frutiger Aero
preset: brushed-metal
description: Aluminum texture, recessed displays, gel transport buttons, and early media-app chrome.
artifact_anchor: QuickTime Player, iTunes brushed metal, and early Mac media controls.
...
typography:
  primary: "Lucida Grande, Tahoma, Verdana"
...
components:
  brushed_metal_shell:
    description: "brushed metal shell in Brushed Metal Player vocabulary. Keep it visibly period-specific, not modernized."
  recessed_LCD_display:
    description: "recessed LCD display in Brushed Metal Player vocabulary. Keep it visibly period-specific, not modernized."
  gel_transport_buttons:
    description: "gel transport buttons in Brushed Metal Player vocabulary. Keep it visibly period-specific, not modernized."
  playlist_table:
    description: "playlist table in Brushed Metal Player vocabulary. Keep it visibly period-specific, not modernized."
  reflection_strip:
    description: "reflection strip in Brushed Metal Player vocabulary. Keep it visibly period-specific, not modernized."
---

# Brushed Metal Player

Aluminum texture, recessed displays, gel transport buttons, and early media-app chrome.

## Era Anchor

**Artifact:** QuickTime Player, iTunes brushed metal, and early Mac media controls.
...
Silver brushed texture panel, dark LCD-like display, round gel transport controls,
reflection floor.
...
Use: Lucida Grande, Tahoma, Verdana.
...
Presentation as media player: title in display window, content as playlist/timeline,
controls footer.
...
- **brushed metal shell** — Use as a core building block. Make it obvious and literal.
- **recessed LCD display** — Use as a core building block. Make it obvious and literal.
- **gel transport buttons** — Use as a core building block. Make it obvious and literal.
- **playlist table** — Use as a core building block. Make it obvious and literal.
- **reflection strip** — Use as a core building block. Make it obvious and literal.

## Motion

Subtle playhead progress and button press states.
