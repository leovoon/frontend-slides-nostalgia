...
name: Bondi Aqua Boot
slug: bondi-aqua-boot
taxonomy: Y2K / Aqua / Frutiger Aero
preset: aqua-gel
description: Aqua pinstripes, gel buttons, candy progress bars, and translucent Bondi-blue optimism.
artifact_anchor: Mac OS X Aqua boot/login surfaces and iMac G3 translucent plastic.
...
components:
  aqua_gel_button:
    description: "aqua gel button in Bondi Aqua Boot vocabulary. Keep it visibly period-specific, not modernized."
  pinstripe_background:
    description: "pinstripe background in Bondi Aqua Boot vocabulary. Keep it visibly period-specific, not modernized."
  candy_progress_bar:
    description: "candy progress bar in Bondi Aqua Boot vocabulary. Keep it visibly period-specific, not modernized."
  traffic_light_dots:
    description: "traffic-light dots in Bondi Aqua Boot vocabulary. Keep it visibly period-specific, not modernized."
  gloss_highlight:
    description: "gloss highlight in Bondi Aqua Boot vocabulary. Keep it visibly period-specific, not modernized."
---

# Bondi Aqua Boot

Aqua pinstripes, gel buttons, candy progress bars, and translucent Bondi-blue optimism.

## Era Anchor

**Artifact:** Mac OS X Aqua boot/login surfaces and iMac G3 translucent plastic.
...
Pale blue pinstripe background, central aqua gel pill, white highlight bands, candy
progress bar.
...
Centered boot panel with large gel title, progress indicator, toolbar footer.
...
- **aqua gel button** — Use as a core building block. Make it obvious and literal.
- **pinstripe background** — Use as a core building block. Make it obvious and literal.
- **candy progress bar** — Use as a core building block. Make it obvious and literal.
- **traffic-light dots** — Use as a core building block. Make it obvious and literal.
- **gloss highlight** — Use as a core building block. Make it obvious and literal.

## Motion

Sheen sweep across gel objects and slow progress fill.
