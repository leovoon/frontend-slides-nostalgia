...
name: WordArt Rainbow Splash
slug: wordart-rainbow-splash
taxonomy: Office 97 / PowerPoint
preset: powerpoint-wordart
description: Rainbow arched WordArt, starburst badges, 3D extrusion shadows, and unapologetic slide-art chaos.
artifact_anchor: PowerPoint/Word WordArt gallery, star AutoShapes, and 3D extrude presets.
...
typography:
  primary: "Impact, Arial Black, Comic Sans MS"
...
components:
  rainbow_WordArt_title:
    description: "rainbow WordArt title in WordArt Rainbow Splash vocabulary. Keep it visibly period-specific, not modernized."
  explosion_starburst:
    description: "explosion starburst in WordArt Rainbow Splash vocabulary. Keep it visibly period-specific, not modernized."
  3D_shadow_duplicate:
    description: "3D shadow duplicate in WordArt Rainbow Splash vocabulary. Keep it visibly period-specific, not modernized."
  red_arrow_AutoShape:
    description: "red arrow AutoShape in WordArt Rainbow Splash vocabulary. Keep it visibly period-specific, not modernized."
  beveled_caption_plaque:
    description: "beveled caption plaque in WordArt Rainbow Splash vocabulary. Keep it visibly period-specific, not modernized."
---

# WordArt Rainbow Splash

Rainbow arched WordArt, starburst badges, 3D extrusion shadows, and unapologetic slide-
art chaos.

## Era Anchor

**Artifact:** PowerPoint/Word WordArt gallery, star AutoShapes, and 3D extrude presets.
...
Giant warped rainbow headline with black outline, yellow explosion burst, red arrow, and
chrome drop shadows.
...
Use: Impact, Arial Black, Comic Sans MS.
...
Poster-style center object, sparse supporting text in beveled labels.
...
- **rainbow WordArt title** — Use as a core building block. Make it obvious and literal.
- **explosion starburst** — Use as a core building block. Make it obvious and literal.
- **3D shadow duplicate** — Use as a core building block. Make it obvious and literal.
- **red arrow AutoShape** — Use as a core building block. Make it obvious and literal.
- **beveled caption plaque** — Use as a core building block. Make it obvious and literal.

## Motion

WordArt zooms in, starburst pops, then freezes.
