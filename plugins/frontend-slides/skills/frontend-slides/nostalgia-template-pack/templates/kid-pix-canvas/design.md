...
preset: kid-pix-canvas
description: Tool palettes, stamp grids, paint-bucket colors, wacky brush marks, and cheerful pixel mess.
artifact_anchor: Kid Pix canvas with tool palette, stamps, spray paint, and color strip.
...
typography:
  primary: "Chicago, Comic Sans MS, Geneva"
...
components:
  tool_palette:
    description: "tool palette in Kid Pix Canvas vocabulary. Keep it visibly period-specific, not modernized."
  stamp_sticker:
    description: "stamp sticker in Kid Pix Canvas vocabulary. Keep it visibly period-specific, not modernized."
  spray_speckle:
    description: "spray speckle in Kid Pix Canvas vocabulary. Keep it visibly period-specific, not modernized."
  color_strip:
    description: "color strip in Kid Pix Canvas vocabulary. Keep it visibly period-specific, not modernized."
  paint_bucket_label:
    description: "paint bucket label in Kid Pix Canvas vocabulary. Keep it visibly period-specific, not modernized."
---

# Kid Pix Canvas

Tool palettes, stamp grids, paint-bucket colors, wacky brush marks, and cheerful pixel
mess.

## Era Anchor

**Artifact:** Kid Pix canvas with tool palette, stamps, spray paint, and color strip.
...
White canvas inside Mac window, left tool grid, bottom color strip, stamped icons and
rotated labels.
...
Use: Chicago, Comic Sans MS, Geneva.
...
Large drawing canvas with tool palette sidebar and scattered stamp-like content blocks.
...
- **tool palette** — Use as a core building block. Make it obvious and literal.
- **stamp sticker** — Use as a core building block. Make it obvious and literal.
- **spray speckle** — Use as a core building block. Make it obvious and literal.
- **color strip** — Use as a core building block. Make it obvious and literal.
- **paint bucket label** — Use as a core building block. Make it obvious and literal.

## Motion

Stamp pop-in and spray reveal, capped at two effects.
