...
name: Comic Sans Casual Deck
slug: comic-sans-casual
taxonomy: Office 97 / PowerPoint
preset: comic-sans-classroom
description: Pale yellow slides, Comic Sans, speech bubbles, clip-art-ish symbols, and friendly chaos.
artifact_anchor: Elementary school computer lab presentations and family PowerPoint albums.
...
typography:
  primary: "Comic Sans MS, Arial Rounded MT Bold, Verdana"
...
components:
  speech_bubble_callout:
    description: "speech bubble callout in Comic Sans Casual Deck vocabulary. Keep it visibly period-specific, not modernized."
  smiley_badge:
    description: "smiley badge in Comic Sans Casual Deck vocabulary. Keep it visibly period-specific, not modernized."
  star_bullet_list:
    description: "star bullet list in Comic Sans Casual Deck vocabulary. Keep it visibly period-specific, not modernized."
  dotted_divider:
    description: "dotted divider in Comic Sans Casual Deck vocabulary. Keep it visibly period-specific, not modernized."
  clip_art_placeholder_box:
    description: "clip-art placeholder box in Comic Sans Casual Deck vocabulary. Keep it visibly period-specific, not modernized."
---

# Comic Sans Casual Deck

Pale yellow slides, Comic Sans, speech bubbles, clip-art-ish symbols, and friendly
chaos.

## Era Anchor

**Artifact:** Elementary school computer lab presentations and family PowerPoint albums.
...
Pale yellow notebook-like background, Comic Sans headings, callout balloons, smiley/star
glyphs, mismatched fills.
...
Use: Comic Sans MS, Arial Rounded MT Bold, Verdana.
...
Loose collage of callouts and bullets with slightly rotated stickers.
...
- **speech bubble callout** — Use as a core building block. Make it obvious and literal.
- **smiley badge** — Use as a core building block. Make it obvious and literal.
- **star bullet list** — Use as a core building block. Make it obvious and literal.
- **dotted divider** — Use as a core building block. Make it obvious and literal.
- **clip-art placeholder box** — Use as a core building block. Make it obvious and literal.

## Motion

Simple bounce-free pop-ins; keep readable.
