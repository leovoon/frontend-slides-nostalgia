...
name: PowerPoint Blue Daybreak
slug: powerpoint-blue-daybreak
taxonomy: Office 97 / PowerPoint
preset: powerpoint-daybreak
description: Blue diagonal preset gradient, white text, harsh banding, and boxed content panels.
artifact_anchor: Classic PowerPoint 'blue daybreak' / ocean gradient template aesthetics.
...
typography:
  primary: "Arial Black, Arial, Verdana"
...
components:
  banded_gradient_background:
    description: "banded gradient background in PowerPoint Blue Daybreak vocabulary. Keep it visibly period-specific, not modernized."
  drop_shadow_title:
    description: "drop-shadow title in PowerPoint Blue Daybreak vocabulary. Keep it visibly period-specific, not modernized."
  outlined_content_well:
    description: "outlined content well in PowerPoint Blue Daybreak vocabulary. Keep it visibly period-specific, not modernized."
  corner_page_number:
    description: "corner page number in PowerPoint Blue Daybreak vocabulary. Keep it visibly period-specific, not modernized."
  cyan_divider_rule:
    description: "cyan divider rule in PowerPoint Blue Daybreak vocabulary. Keep it visibly period-specific, not modernized."
---

# PowerPoint Blue Daybreak

Blue diagonal preset gradient, white text, harsh banding, and boxed content panels.

## Era Anchor

**Artifact:** Classic PowerPoint 'blue daybreak' / ocean gradient template aesthetics.
...
Full 1920×1080 blue diagonal gradient, white Arial title with gray drop shadow,
translucent-ish inset rectangles, cyan rules.
...
Full-bleed gradient, centered title, lower white outlined content box, slide number
badge.
...
- **banded gradient background** — Use as a core building block. Make it obvious and literal.
- **drop-shadow title** — Use as a core building block. Make it obvious and literal.
- **outlined content well** — Use as a core building block. Make it obvious and literal.
- **corner page number** — Use as a core building block. Make it obvious and literal.
- **cyan divider rule** — Use as a core building block. Make it obvious and literal.

## Motion

Checkerboard or dissolve-style intro; avoid modern easing.
