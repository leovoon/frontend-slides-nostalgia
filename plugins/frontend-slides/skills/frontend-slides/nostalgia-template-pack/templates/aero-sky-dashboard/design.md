...
name: Aero Sky Dashboard
slug: aero-sky-dashboard
taxonomy: Y2K / Aqua / Frutiger Aero
preset: frutiger-aero
description: Sky-to-grass gradient, bubbles, glass panels, leaf-green accents, and cheerful dashboard optimism.
artifact_anchor: Vista-era Frutiger Aero wallpapers, Wii-era UI, bubbles, glass, green-blue ecological tech.
...
typography:
  primary: "Segoe UI, Tahoma, Verdana"
...
components:
  glass_stat_card:
    description: "glass stat card in Aero Sky Dashboard vocabulary. Keep it visibly period-specific, not modernized."
  floating_bubble:
    description: "floating bubble in Aero Sky Dashboard vocabulary. Keep it visibly period-specific, not modernized."
  grass_horizon:
    description: "grass horizon in Aero Sky Dashboard vocabulary. Keep it visibly period-specific, not modernized."
  gloss_tab:
    description: "gloss tab in Aero Sky Dashboard vocabulary. Keep it visibly period-specific, not modernized."
  leaf_green_badge:
    description: "leaf-green badge in Aero Sky Dashboard vocabulary. Keep it visibly period-specific, not modernized."
---

# Aero Sky Dashboard

Sky-to-grass gradient, bubbles, glass panels, leaf-green accents, and cheerful dashboard
optimism.

## Era Anchor

**Artifact:** Vista-era Frutiger Aero wallpapers, Wii-era UI, bubbles, glass, green-blue ecological tech.
...
Blue sky gradient into green floor, floating bubbles, translucent white panels with
...
Dashboard cards floating over sky/grass scene; big friendly status panel.
...
- **glass stat card** — Use as a core building block. Make it obvious and literal.
- **floating bubble** — Use as a core building block. Make it obvious and literal.
- **grass horizon** — Use as a core building block. Make it obvious and literal.
- **gloss tab** — Use as a core building block. Make it obvious and literal.
- **leaf-green badge** — Use as a core building block. Make it obvious and literal.

## Motion

Slow bubble drift and soft sheen; never obscure text.
