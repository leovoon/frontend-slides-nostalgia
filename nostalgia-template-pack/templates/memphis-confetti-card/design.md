...
name: Memphis Confetti Card
slug: memphis-confetti-card
taxonomy: System 7 / Kid Pix / Memphis
preset: memphis-lab
description: Primary shapes, squiggles, terrazzo dots, worksheet panels, and handmade desktop-publishing joy.
artifact_anchor: Late-80s/early-90s Memphis graphics in classroom worksheets and desktop publishing.
...
typography:
  primary: "Arial Black, Comic Sans MS, Geneva"
...
components:
  confetti_frame:
    description: "confetti frame in Memphis Confetti Card vocabulary. Keep it visibly period-specific, not modernized."
  squiggle_rule:
    description: "squiggle rule in Memphis Confetti Card vocabulary. Keep it visibly period-specific, not modernized."
  worksheet_blank:
    description: "worksheet blank in Memphis Confetti Card vocabulary. Keep it visibly period-specific, not modernized."
  tilted_label:
    description: "tilted label in Memphis Confetti Card vocabulary. Keep it visibly period-specific, not modernized."
  primary_color_chip:
    description: "primary color chip in Memphis Confetti Card vocabulary. Keep it visibly period-specific, not modernized."
---

# Memphis Confetti Card

Primary shapes, squiggles, terrazzo dots, worksheet panels, and handmade desktop-
publishing joy.

## Era Anchor

**Artifact:** Late-80s/early-90s Memphis graphics in classroom worksheets and desktop publishing.
...
White card with black outlines, primary confetti shapes, squiggles, dotted fields, and
playful tilted labels.
...
Use: Arial Black, Comic Sans MS, Geneva.
...
Centered worksheet card with confetti frame and bold filled-in-the-blank regions.
...
- **confetti frame** — Use as a core building block. Make it obvious and literal.
- **squiggle rule** — Use as a core building block. Make it obvious and literal.
- **worksheet blank** — Use as a core building block. Make it obvious and literal.
- **tilted label** — Use as a core building block. Make it obvious and literal.
- **primary color chip** — Use as a core building block. Make it obvious and literal.

## Motion

Shapes jitter in once, then stay still.
