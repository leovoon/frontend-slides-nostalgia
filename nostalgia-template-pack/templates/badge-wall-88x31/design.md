...
name: 88×31 Badge Wall
slug: badge-wall-88x31
taxonomy: GeoCities / Web 1.0
preset: badge-wall
description: Dense grid of tiny badges, awards, Netscape buttons, HTML pride, and ring navigation.
artifact_anchor: 88×31 badge strips and award walls on personal websites.
...
typography:
  primary: "Arial, Verdana, Times New Roman"
...
components:
  88x31_badge_cells:
    description: "88x31 badge cells in 88×31 Badge Wall vocabulary. Keep it visibly period-specific, not modernized."
  award_ribbon:
    description: "award ribbon in 88×31 Badge Wall vocabulary. Keep it visibly period-specific, not modernized."
  best_viewed_button:
    description: "best viewed button in 88×31 Badge Wall vocabulary. Keep it visibly period-specific, not modernized."
  webring_nav:
    description: "webring nav in 88×31 Badge Wall vocabulary. Keep it visibly period-specific, not modernized."
  odometer_counter:
    description: "odometer counter in 88×31 Badge Wall vocabulary. Keep it visibly period-specific, not modernized."
---

# 88×31 Badge Wall

Dense grid of tiny badges, awards, Netscape buttons, HTML pride, and ring navigation.

## Era Anchor

**Artifact:** 88×31 badge strips and award walls on personal websites.
...
Silver/black table grid packed with badge-like cells, colored mini logos, fake award
ribbons, webring controls.
...
Use: Arial, Verdana, Times New Roman.
...
Badge grid with footer webring controls and visitor counter.
...
- **88x31 badge cells** — Use as a core building block. Make it obvious and literal.
- **award ribbon** — Use as a core building block. Make it obvious and literal.
- **best viewed button** — Use as a core building block. Make it obvious and literal.
- **webring nav** — Use as a core building block. Make it obvious and literal.
- **odometer counter** — Use as a core building block. Make it obvious and literal.

## Motion

Badges can shimmer one at a time; no full-page chaos.
