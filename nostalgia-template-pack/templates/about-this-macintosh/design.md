...
slug: about-this-macintosh
taxonomy: System 7 / Kid Pix / Memphis
preset: about-this-mac
description: System info dialog boxes, memory bars, tiny icons, version rows, and satisfying monochrome order.
artifact_anchor: About This Macintosh dialog and System 7 control panels.
...
components:
  modal_dialog:
    description: "modal dialog in About This Macintosh vocabulary. Keep it visibly period-specific, not modernized."
  memory_meter:
    description: "memory meter in About This Macintosh vocabulary. Keep it visibly period-specific, not modernized."
  OK_button:
    description: "OK button in About This Macintosh vocabulary. Keep it visibly period-specific, not modernized."
  system_icon:
    description: "system icon in About This Macintosh vocabulary. Keep it visibly period-specific, not modernized."
  field_row:
    description: "field row in About This Macintosh vocabulary. Keep it visibly period-specific, not modernized."
---

# About This Macintosh

System info dialog boxes, memory bars, tiny icons, version rows, and satisfying
monochrome order.

## Era Anchor

**Artifact:** About This Macintosh dialog and System 7 control panels.
...
Centered modal dialog, tiny Mac icon, black divider lines, memory bars, field labels, OK
button.
...
Dialog-first composition with rows, meters, small icon boxes, and command buttons.
...
- **modal dialog** — Use as a core building block. Make it obvious and literal.
- **memory meter** — Use as a core building block. Make it obvious and literal.
- **OK button** — Use as a core building block. Make it obvious and literal.
- **system icon** — Use as a core building block. Make it obvious and literal.
- **field row** — Use as a core building block. Make it obvious and literal.

## Motion

No flourish; dialog simply appears, maybe button depresses.
