...
name: GeoCities Welcome Homepage
slug: geocities-welcome
taxonomy: GeoCities / Web 1.0
preset: geocities-homepage
description: Tiled star background, centered table, marquee welcome, visitor counter, and best-viewed badges.
artifact_anchor: GeoCities homepage with centered table, background tile, marquee, counter, and badges.
...
typography:
  primary: "Times New Roman, Comic Sans MS, Courier New"
...
components:
  star_tiled_body:
    description: "star tiled body in GeoCities Welcome Homepage vocabulary. Keep it visibly period-specific, not modernized."
  marquee_strip:
    description: "marquee strip in GeoCities Welcome Homepage vocabulary. Keep it visibly period-specific, not modernized."
  visitor_counter:
    description: "visitor counter in GeoCities Welcome Homepage vocabulary. Keep it visibly period-specific, not modernized."
  blue_purple_link_list:
    description: "blue/purple link list in GeoCities Welcome Homepage vocabulary. Keep it visibly period-specific, not modernized."
  88x31_badge_row:
    description: "88x31 badge row in GeoCities Welcome Homepage vocabulary. Keep it visibly period-specific, not modernized."
---

# GeoCities Welcome Homepage

Tiled star background, centered table, marquee welcome, visitor counter, and best-viewed
badges.

## Era Anchor

**Artifact:** GeoCities homepage with centered table, background tile, marquee, counter, and badges.
...
Black star tile, 760px centered content table, rainbow header, blue links, yellow
marquee strip, odometer counter.
...
Use: Times New Roman, Comic Sans MS, Courier New.
...
Nested visible tables inside fixed stage; header, nav row, content cell, footer badges.
...
- **star tiled body** — Use as a core building block. Make it obvious and literal.
- **marquee strip** — Use as a core building block. Make it obvious and literal.
- **visitor counter** — Use as a core building block. Make it obvious and literal.
- **blue/purple link list** — Use as a core building block. Make it obvious and literal.
- **88x31 badge row** — Use as a core building block. Make it obvious and literal.

## Motion

Scrolling marquee and tiny GIF-like twinkles; reduced motion disables.
